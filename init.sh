...
LIBS="org.scala-lang:scala-library:2.12.8 org.scala-lang:scala-compiler:2.12.8 org.scala-lang:scala-reflect:2.12.8"
JARS=$(bin/coursier fetch -r sonatype:releases $LIBS)
CLASSPATH=$(echo $JARS | sed -e s/[[:blank:]]/\",\"/g)

COMPILER_LIBS="org.scala-lang:scala-library:2.12.8 org.scala-lang:scala-compiler:2.12.8 org.scala-lang:scala-reflect:2.12.8"
